...
<div class="form">
              ...
              <div class="form-item">          
                  <select class="classic" id='manager_status'>
                    <option disabled selected>Manager status</option>
              ...
              <div class="form-item">          
                <input type="text" id="manager_names" autocomplete="off" required>
                <label for="branch_manager">Manager names</label>
              </div>
              <div id='sub-35' class="b">
                SUBMIT
              </div>
</div>
